...
The analysis primarily utilized the R language and environment [@citeR], leveraging its robust statistical capabilities and extensive library ecosystem. Specifically, the ggplot2 package [@citeggplot2] was employed for visualizing observations and trends following each stage of data manipulation.
...
#| eval: true
#| label: tbl-table1
#| tbl-cap: Summary Statistics of Data
#| warning: false
