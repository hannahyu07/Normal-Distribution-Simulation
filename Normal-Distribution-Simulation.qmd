...
The analysis primarily utilized the R language and environment [@citeR]. Specifically, we employed the ggplot2 package [@citeggplot2] to visualize observations and trends.
...
summary_str <- capture.output(print(summary_stats))

# Calculate the number of empty spaces to center the table
num_empty_spaces <- (getOption("width") - nchar(summary_str)) / 2

# Print the summary statistics centered
cat(sprintf("%*s\n", num_empty_spaces + nchar(summary_str), summary_str))
...
# Convert summary statistics to a character string
summary_str <- capture.output(print(summary_stats1))
